...
class Controleur:
    ...
    def reset(self):
        """
        remet la distance parcouru et l'angle parcour par le robot a 0
        """
        self._angleParcouru=0
        self._distanceParcourue=0
...
class ControleurRobotVirtuel(Controleur):
    ...
    def get_distance_obstacle(self):
        """ 
        return: la distance a l'obstacle le plus proche d'un obstacle
        """
...
class ControleurRobotVraieVie(Controleur):
    ...
    def reset(self):
        """
        remet la distance parcouru et l'angle parcouru par le robot a 0 
